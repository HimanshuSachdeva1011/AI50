...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Mark the cells as a move is made, and mark it safe:
        ...
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                # If cells are marked safe, ignore them:
                ...
                # Else add them to sentence if they are in the game board:
                if 0 <= i < self.height and 0 <= j < self.width:
    ...
    def make_safe_move(self):
        ...
        # Get a set of those safe cells that are not moves already done:
        safe_moves = self.safes - self.moves_made
        if safe_moves:
            return random.choice(list(safe_moves))

        # Else no guaranteed safe moves can be made
        return None
    ...
    def make_random_move(self):
        ...
        # Get a list of all possible moves that are not mines
        ...
        # Else can potentially improve random choice using KB:
        elif moves:
            for sentence in self.knowledge:
            ...
            # Returns a random choice from the best moves list
            return move